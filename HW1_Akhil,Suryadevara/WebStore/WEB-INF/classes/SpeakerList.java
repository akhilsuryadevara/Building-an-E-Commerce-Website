...
public class SpeakerList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			if(CategoryName.equalsIgnoreCase("GoogleHomeMini"))
		   {
			 for(Map.Entry<String,Speaker> entry : SaxParserDataStore.speakers.entrySet())
			 {
				if(entry.getValue().getName().equalsIgnoreCase("GoogleHomeMini"))
				 {
		   ...
		   else if(CategoryName.equalsIgnoreCase("Logitech"))
		   {
			 for(Map.Entry<String,Speaker> entry : SaxParserDataStore.speakers.entrySet())
			 {
				if(entry.getValue().getName().equalsIgnoreCase("Logitech"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
			 }
		   ...
		   else if(CategoryName.equalsIgnoreCase("Bose"))
		    {
			for(Map.Entry<String,Speaker> entry : SaxParserDataStore.speakers.entrySet())
				{
				 if(entry.getValue().getName().equalsIgnoreCase("Bose"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equalsIgnoreCase("Sony"))
			{
				for(Map.Entry<String,Speaker> entry : SaxParserDataStore.speakers.entrySet())
				{
				 if(entry.getValue().getName().equalsIgnoreCase("Sony"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
