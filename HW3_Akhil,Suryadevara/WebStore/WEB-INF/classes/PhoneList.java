	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
		 if(CategoryName.equalsIgnoreCase("Samsung"))
		   {
		   ...
		   else if(CategoryName.equalsIgnoreCase("OnePlus"))
		    {
			for(Map.Entry<String,Phone> entry : SaxParserDataStore.phones.entrySet())
				{
				 if(entry.getValue().getName().equalsIgnoreCase("OnePlus"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
			...
			else if(CategoryName.equalsIgnoreCase("Iphone"))
			{
				for(Map.Entry<String,Phone> entry : SaxParserDataStore.phones.entrySet())
				{
				 if(entry.getValue().getName().equalsIgnoreCase("Iphone"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
