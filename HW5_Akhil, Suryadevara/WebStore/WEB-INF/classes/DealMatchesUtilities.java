...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a href='#'>Welcome to Smart Portables - One Stop for Every Tech you Need!</a></h2>");
		
		pw.print("<div class='entry'>");
		pw.print("<img src='images/deals.jpg'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		pw.print("<br> <br>");
		pw.print("<h2>The world trusts us to deliver SPEEDY service for Tech fans</h2>");
		pw.print("<br> <br>");
